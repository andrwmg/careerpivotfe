...
export default function PostCard({ post, showComments, commentCount }) {
    ...
    return (
        <Card sx={{ width: '100%', minHeight: '237px', bgcolor: 'rgba(232, 235, 255, 0)', color: 'black', p: 3, borderRadius: 2, border: '1px solid #E8EBFF', boxShadow: '0px 0px 5px rgba(0, 0, 0, 0.2)', display: 'flex', flexDirection: 'column', alignItems: 'start', gap: 3, flexGrow: 1}}>
            ...
            {post ?
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: .5 }} style={{ flexGrow: 1, height: '100%' }}>
                    <Grid container item direction='column' gap={3}>
                        <Grid container item gap={1} flexGrow={1}>
                        ...
                        <Grid container item justifyContent='start' alignItems='center' gap={4} color='primary'>
                            <Grid container item direction='column' xs='auto'>
                                <Grid container item alignItems='center'>
                                    ...
                                    <Typography variant='h4' color='black' minWidth='9px'>{formatCount(likeCount)}</Typography>
                                </Grid>
                            </Grid>
                            <Grid container item direction='column' xs>
                                <Grid container item xs='auto' alignItems='center'>
                                    ...
                                    <Typography variant='h4' color='black' textAlign='start' minWidth='9px'>{formatCount(commentCount)}</Typography>
                                </Grid>
                            </Grid>
                ...
                <Grid container item direction='column' gap={3}>
                    <Grid container item gap={1} flexGrow={1}>
                        <Grid container item direction='column' xs={12}>
                            <Typography variant="h3" lineHeight='35px'>
                                <Skeleton />
                            </Typography>
                        </Grid>
                        <Grid container item direction='column' xs={12}>
